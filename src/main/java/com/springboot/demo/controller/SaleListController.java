...
//	}
	...
	@GetMapping(value="/daily/cost", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@GetMapping(value="/daily/cups", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@GetMapping(value="/total/cost", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@GetMapping(value="/total/cups", produces = MediaType.APPLICATION_JSON_VALUE)
